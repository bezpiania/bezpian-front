    ...
    createChatbot(
      { workspaceId, chatbotData: formData },
      {
        onSuccess: (response) => {
          ...
          message.success('¡Øpia creado! Ahora configúralo a tu gusto.');
      ...
      <section className="form-side">
        <div className="topbar">
          <div className="brand">
            ...
            <div className="brand-name">Øpia</div>
          </div>
        ...
        <div className="form-body">
          ...
          {step.id === 'openai' && (
            <div className="step active">
              ...
              <p className="step-sub">
                Este paso es <strong>completamente opcional por ahora</strong>. Si no tienes tu API key de OpenAI a mano, créa tu Øpia igual y agrégala después desde la configuración del bot.
              </p>
